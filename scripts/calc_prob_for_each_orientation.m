	    ...
	    if d ~= 0
	        for i=-max_angle_err:resolution_angle:max_angle_err
	            for j=-max_shift_err:resolution_space:max_shift_err
	                ...
	                [~, dist_proj] = numer_posterior_probability_orientation(...
                    ...
                    dist_k_orient = dist_proj_matrix(:, :, k) - dist_proj;
                    prob_k_orient = exp(dist_k_orient);
                    final_prob_i_orient = 1/(sum(prob_k_orient.*prior_matrix));
